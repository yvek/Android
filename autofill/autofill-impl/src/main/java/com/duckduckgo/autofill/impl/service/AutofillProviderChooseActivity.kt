...
class AutofillProviderChooseActivity : DuckDuckGoActivity() {
    ...
    @Inject
    lateinit var suggestionsFormatter: AutofillServiceSuggestionCredentialFormatter

    @Inject
    lateinit var appBuildConfig: AppBuildConfig

    @Inject
    lateinit var viewProvider: AutofillServiceViewProvider
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setTitle(R.string.autofill_service_choose_password_activity)
        observeViewModel()
    }
    ...
    fun autofillLogin(credential: LoginCredentials) {
        ...
        val dataset = buildDataset(fields, credential)
